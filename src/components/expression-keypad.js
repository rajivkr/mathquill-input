      ...
      <View style={rightPageStyle}>
        <View style={[column, oneColumn, colCenter]}>
          <TouchableKeypadButton
            keyConfig={
              this.props.numPad == true ? KeyConfigs.NUM_7 : KeyConfigs.a
            }
            borders={BorderStyles.NONE}
          />
          <TouchableKeypadButton
            keyConfig={
              this.props.numPad == true ? KeyConfigs.NUM_4 : KeyConfigs.x
            }
            borders={BorderStyles.NONE}
          />
          <TouchableKeypadButton
            keyConfig={
              this.props.numPad == true ? KeyConfigs.NUM_1 : KeyConfigs.p
            }
        ...
        <View style={[column, oneColumn, colCenter]}>
          <TouchableKeypadButton
            keyConfig={
              this.props.numPad == true ? KeyConfigs.NUM_8 : KeyConfigs.b
            }
            borders={BorderStyles.NONE}
          />
          <TouchableKeypadButton
            keyConfig={
              this.props.numPad == true ? KeyConfigs.NUM_5 : KeyConfigs.y
            }
            borders={BorderStyles.NONE}
          />
          <TouchableKeypadButton
            keyConfig={
              this.props.numPad == true ? KeyConfigs.NUM_2 : KeyConfigs.q
            }
            borders={BorderStyles.NONE}
          />
          <TouchableKeypadButton
            keyConfig={
              this.props.numPad == true ? KeyConfigs.NUM_0 : KeyConfigs.s
            }
        ...
        <View style={[column, oneColumn, colCenter]}>
          <TouchableKeypadButton
            keyConfig={
              this.props.numPad == true ? KeyConfigs.NUM_9 : KeyConfigs.c
            }
            borders={BorderStyles.NONE}
          />
          <TouchableKeypadButton
            keyConfig={
              this.props.numPad == true ? KeyConfigs.NUM_6 : KeyConfigs.z
            }
            borders={BorderStyles.NONE}
          />
          <TouchableKeypadButton
            keyConfig={
              this.props.numPad == true ? KeyConfigs.NUM_3 : KeyConfigs.r
            }
            borders={BorderStyles.BOTTOM}
          />
          <TouchableKeypadButton
